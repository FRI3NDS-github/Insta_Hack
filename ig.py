...
vpn'ye bağlıdır. Lütfen aracı çalıştırmadan veya bir proxy dosyası sağlamadan önce kullanın           """"""""""""""""""""""""""""""""""""""""""
''')
...
class InstaBrute(object):
    def __init__(self):
        ...
        try:
            ...
            self.CurrentProxy = ''
            self.UsedProxys = []
            UsePorxy = input('[*] proxy kullanmak istiyor musun? (y/n): ').upper()
